  ...
  return (
    <div className='bg-[#ffffff] w-full py-20'>
        <div className='max-w-[1600px] w-[90%] flex flex-col mx-auto'>
            ...
            <h1 className='text-[#666666] font-[400] font-dmsans text-[14px] mt-3'>We help your business through digital product <br/> that are stand-alone or connect to physical products and services.</h1>
                    ...
                    {card.map((cards, index)=>{
                        ...
                        <div key={index} className='w-full min-h-min h-fit bg-white rounded-[20px] test p-6'>
                            <div className='flex flex-col relative'>
                                ...
                                <h1 className='mt-[55px] font-[600] text-[18px] text-[#333333] font-dmsans'>{cards.title}</h1>
                                <h1 className='mt-3 max-w-[80%] font-[400] text-[14px] font-dmsans text-[#5B5F6A]'>{cards.subtitle}</h1>
                                <ul className='ml-4 mt-2 list-disc marker:text-[#5B5F6A]'>
                                    {cards.content.map((contents, index)=>{
                                        return <li className='font-[400] text-[14px] text-[#5B5F6A] font-dmsans' key={index}>{contents}</li>
                                    })}
                                </ul>
                            </div>
                        </div>
