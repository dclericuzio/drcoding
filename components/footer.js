        ...
        <div className='max-w-full w-full md:w-[90%] flex flex-col md:flex-row items-center justify-between md:mx-auto'>
            <div className='flex flex-col'>
              <img src='./logo.png' className='w-40'/>
                <h1 className='md:block hidden text-center text-[14px] text-[#f3f3f3]'>© 2023 DR CODING. All Rights Reserved By DR CODING Team</h1>
            </div>
            ...
            <h1 className='md:hidden block text-center text-[12px] sm:text-[14px font-dmsans text-[#f3f3f3]'>© 2023 DR CODING. All Rights Reserved By DR CODING Team</h1>
        </div>
    </div>
  )
}
